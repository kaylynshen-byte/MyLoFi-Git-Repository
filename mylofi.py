...
# PLAY BUTTON COMMAND:
def start():
    # Path to base directory is where the 'mylofi.py' file and 'lofitrack' folder are located (home/parent)
    base_dir = pathlib.Path(__file__).resolve().parent 

    # Attaching base directory file path to a file name
    file1 = base_dir / "lofitrack/pianochords.mp3"
    file2 = base_dir / "lofitrack/bass.mp3"
    file3 = base_dir / "lofitrack/drums.mp3"
    file4 = base_dir / "lofitrack/highhat.mp3"
    file5 = base_dir / "lofitrack/pianomelody.mp3"
    file6 = base_dir / "lofitrack/cafechatter.mp3"
    file7 = base_dir / "lofitrack/vinylcrackle.mp3"
